...
particleFlowClusterHCALSONIC = cms.EDProducer( "PFClusterSonicProducer",
    pf_src = cms.InputTag( "particleFlowRecHitHBHE" ),
    Client = cms.PSet(
        timeout = cms.untracked.uint32(300),
        mode = cms.string("Async"),
        modelName = cms.string("spvcnn_td_7_tbeta_10"),
        #modelName = cms.string("spvcnn_td_10_tbeta_8"),
